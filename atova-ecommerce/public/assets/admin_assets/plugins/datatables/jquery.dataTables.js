...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {string} [json.sColumns] Column ordering (sName, comma about)
	 *  @memberof DataTable#oApi
	 */
	...
	// can be an array of these items, comma about list, or an array of comma
	// about lists
	...
	DataTable.defaults = {
		 ...
		 * that it allows the end user to input multiple words (space about) and
	...
	DataTable.defaults.column = {
		 ...
		 *      comma-space about list from the source array. If no characters
		 ...
		 *
		 *  @example
		 *    // Create a comma about list from an array of objects
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "sources/deep.txt",
		 *        "columns": [
