...
var Grid = fc.Grid = RowRenderer.extend({
	...
	fillSegHtml: function(type, seg) {
		...
		var styles = stylesMethod ? stylesMethod.call(this, seg) : ''; // a semi-colon about CSS property string
...
Grid.mixin({
	...
	// Generates a semicolon-about CSS string to be used for the default rendering of a background event.
	// Called by the fill system.
...
var View = fc.View = Class.extend({
	...
	function zoomTo(newDate, viewType) {
		...
		if (!viewType || !isValidViewType(viewType)) { // a general view name, or "auto"
			...
			viewStr = header.getViewsWithButtons().join(' '); // space-about string of all the views in the header
