...
angApp.controller('AppController', function($scope, $http) {
    ...
    $scope.productList = function(invoice_id) {
        ...
        $http({
            method : "GET",
            url : $scope.url + "/deliver/admin/invoices/items/" + invoice_id
    ...
    $scope.addProduct = function (selected) {
        ...
        if (selected) {
            $http({
                method  : "POST",
                url     : $scope.url + "/deliver/admin/invoices/items",
                data    : $.param({product_id: selected.originalObject.id, deliver__invoice_id: $scope.invoiceId}),
    ...
    $scope.updateProduct = function (index) {
        ...
        $http({
            method  : "PUT",
            url     : $scope.url + "/deliver/admin/invoices/items/" + $scope.items[index].id,
    ...
    $scope.deleteProduct = function(id, index) {
        ...
        $http({
            method  : "DELETE",
            url     : $scope.url + "/deliver/admin/invoices/items/" + id
        }).then(function mySucces(response) {
            if (response.data == 1){
    ...
    $scope.changeAddition = function() {
        ...
        $http({
            method  : "GET",
            url     : $scope.url + "/deliver/admin/single-add-red/" + $scope.additionId
        }).then(function mySucces(response) {
    ...
    $scope.addAddition = function() {
        ...
        if($scope.additionTitle != '' && $scope.additionAmount != '') {
            $http({
                method  : "POST",
                url     : $scope.url + "/deliver/admin/additions",
                data    : $.param({additionId: $scope.additionId, title: $scope.additionTitle, amount: $scope.additionAmount, deliver__invoice_id: $scope.invoiceId}),
                headers : {'Content-Type': 'application/x-www-form-urlencoded'}
            }).then(function mySucces(response) {
    ...
    $scope.additionList = function(invoice_id) {
        $http({
            method  : "POST",
            url     : $scope.url + "/deliver/admin/additions/" + invoice_id
        }).then(function mySucces(response) {
    ...
    $scope.additionDelete = function(id, index) {
        ...
        $http({
            method  : "DELETE",
            url     : $scope.url + "/deliver/admin/additions/delete/" + id
        }).then(function mySucces(response) {
            if (response.data == 1) {
    ...
    $scope.changeReduction = function() {
        ...
        $http({
            method  : "GET",
            url     : $scope.url + "/deliver/admin/single-add-red/" + $scope.reductionId
        }).then(function mySucces(response) {
    ...
    $scope.addReduction = function() {
        ...
        if($scope.reductionTitle != '' && $scope.reductionAmount != '') {
            $http({
                method  : "POST",
                url     : $scope.url + "/deliver/admin/reductions",
                data    : $.param({reductionId: $scope.reductionId, title: $scope.reductionTitle, amount: $scope.reductionAmount, deliver__invoice_id: $scope.invoiceId}),
                headers : {'Content-Type': 'application/x-www-form-urlencoded'}
            }).then(function mySucces(response) {
    ...
    $scope.reductionList = function(invoice_id) {
        ...
        $http({
            method  : "POST",
            url     : $scope.url + "/deliver/admin/reductions/" + invoice_id
        }).then(function mySucces(response) {
            angular.forEach(response.data, function(value, key) {
    ...
    $scope.reductionDelete = function(id, index) {
        ...
        $http({
            method  : "DELETE",
            url     : $scope.url + "/deliver/admin/reductions/delete/" + id
        }).then(function mySucces(response) {
            if (response.data == 1) {
    ...
    $scope.paymentList = function(invoice_id) {
        $http({
            method  : "GET",
            url     : $scope.url + "/deliver/admin/payments/" + invoice_id
        }).then(function mySucces(response) {
            angular.forEach(response.data, function(value, key) {
    ...
    $scope.addPayment = function() {
        ...
        if($scope.paymentMethod != 0 && $scope.paymentAmount > 0) {
            $http({
                method  : "POST",
                url     : $scope.url + "/deliver/admin/payments",
                data    : $.param({payment_methods_id: $scope.paymentMethod, amount: $scope.paymentAmount, deliver__invoice_id: $scope.invoiceId}),
                headers : {'Content-Type': 'application/x-www-form-urlencoded'}
            }).then(function mySucces(response) {
    ...
    $scope.paymentDelete = function(id, index) {
        ...
        $http({
            method  : "DELETE",
            url     : $scope.url + "/deliver/admin/payments/delete/" + id
        }).then(function mySucces(response) {
            if (response.data == 1) {
