...
<section class="content">
    ...
    <a href="{{ url('hr/admin/designations/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($designations as $designation)
                    <tr>
                        ...
                        <td class="text-right">
                            {{ Form::open(array('method' => 'delete', 'url' => 'hr/admin/designations/' . $designation->id)) }}
                            <a title="Edit" href="{{ url('hr/admin/designations/' . $designation->id .'/edit') }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
