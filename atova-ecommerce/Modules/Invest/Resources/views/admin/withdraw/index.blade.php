...
<section class="content">
    ...
    <a href="{{ url('invest/admin/withdraws/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($withdraws as $withdraw)
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $withdraw->date }} </td>
                        <td>{{ $withdraw->investor->name }}</td>
                        <td>{{ $withdraw->amount }}</td>
                        <td>
                            <a title="Edit" href="{{ url('invest/admin/withdraws/' . $withdraw->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View </a>
                        </td>
                    </tr>
                @endforeach
