...
<section class="content">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($withdraw, ['method'=>'PUT', 'url' => 'invest/admin/withdraws/' . $withdraw->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'invest/admin/withdraws', 'role'=>'form', 'files'=>true]) !!}
    @endif
