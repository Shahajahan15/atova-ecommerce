...
<section class="content">
    ...
    <a href="{{ url('invest/admin/invests') }}" class="btn btn-primary">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($invest, ['method'=>'PUT', 'url' => 'invest/admin/invests/' . $invest->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'invest/admin/invests', 'role'=>'form', 'files'=>true]) !!}
    @endif
        ...
        <div class="col-md-9">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"> Invest Form </h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('investors_id') ? ' has-error' : '' }}">
                        {!! Form::label('investors_id', 'Investor: ', ['class'=>'control-label']) !!}
                        {!! Form::select('investors_id', $investors, NULL, ['class'=> 'form-control select2', 'placeholder'=>'<-- Select Investor -->']) !!}
                        @if ($errors->has('investors_id'))
                            <span class="help-block">
                                <strong>{{ $errors->first('investors_id') }}</strong>
                            </span>
                        @endif
                    </div>
