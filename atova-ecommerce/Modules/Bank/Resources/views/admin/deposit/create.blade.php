...
<section class="content">
    ...
    <a href="{{ url('bank/admin/deposits') }}" class="btn btn-primary">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($deposit, ['method'=>'PUT', 'url' => 'bank/admin/deposits/' . $deposit->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'bank/admin/deposits', 'role'=>'form', 'files'=>true]) !!}
    @endif
