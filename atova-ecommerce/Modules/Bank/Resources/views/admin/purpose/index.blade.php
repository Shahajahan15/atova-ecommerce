...
<section class="content">
    ...
    <a href="{{ url('bank/admin/purposes/create') }}" class="btn btn-primary">
        <i class="fa fa-plus"></i> New purpose
    </a>
    <br/><br/>
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($purposes as $purpose)
                    <tr>
                        ...
                        <td>{{ $purpose->note }}</td>
                        <td class="text-right">
                            {{ Form::open(array('method' => 'delete', 'url' => 'bank/admin/purposes/' . $purpose->id)) }}
                            <a title="Edit" href="{{ url('bank/admin/purposes/' . $purpose->id .'/edit') }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
