...
<section class="content">
    ...
    <a href="{{ url('accounts/admin/payments/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($payments as $payment)
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $payment->id }} </td>
                        <td>{{ $payment->recipient->first_name . ' ' .$payment->recipient->last_name }}</td>
                        <td>{{ $payment->amount }}</td>
                        <td>
                            <a title="Edit" href="{{ url('accounts/admin/payments/' . $payment->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View </a>
                        </td>
                    </tr>
                @endforeach
