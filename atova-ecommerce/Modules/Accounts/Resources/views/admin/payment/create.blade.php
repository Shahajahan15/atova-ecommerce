...
<section class="content">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($payment, ['method'=>'PUT', 'url' => 'accounts/admin/payments/' . $payment->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'accounts/admin/payments', 'role'=>'form', 'files'=>true]) !!}
    @endif
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('reason') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('reason', NULL, ['class'=> 'form-control', 'placeholder'=>'Payment reason']) !!}
