...
<section class="content">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($category, ['method'=>'PUT', 'url' => 'product/admin/categories/' . $category->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'product/admin/categories', 'role'=>'form', 'files'=>true]) !!}
    @endif
            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('parent_id') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('parent_id', $categories, NULL, ['class'=> 'form-control', 'placeholder'=>'Parent']) !!}
