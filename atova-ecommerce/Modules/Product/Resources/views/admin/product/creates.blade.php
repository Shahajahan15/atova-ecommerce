...
<section class="content">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($product, ['method'=>'PUT', 'url' => 'product/admin/products/' . $product->users_id, 'role'=>'form', 'files'=>true]) !!}
    @else
        ...
        <div class="col-md-8">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_3" data-toggle="tab">Specifications</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <span class="text-danger"> <i class="fa fa-star"></i> </span>
                            {!! Form::textarea('description', NULL, ['class'=> 'form-control', 'required' =>'required', 'id'=>'my-editor', 'placeholder'=>'Description']) !!}
                        ...
                        <div class="form-group {{ $errors->has('slug') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('slug', NULL, ['class'=> 'form-control', 'placeholder'=>'Slug', 'ng-model'=>'slug']) !!}
                            @if ($errors->has('slug'))
                                <span class="help-block">
                    ...
                    <div class="tab-pane" id="tab_3">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr ng-repeat="sp in specifications">
                                ...
                                <td>
                                    {!! Form::text('sp_value[]', NULL, ['class'=> 'form-control', 'placeholder'=>'Value']) !!}
                                </td>
                            </tr>
                            ...
                            <div class="row clearfix ">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input id="image" required class="form-control" type="text" name="image">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('categories') ? ' has-error' : '' }}">
                        ...
                        <span class="text-danger"> <i class="fa fa-star"></i> </span>
                        {!! Form::select('categories[]', $categories, NULL, ['class'=> 'form-control select2', 'multiple', 'required']) !!}
                ...
                <div class="box-footer">
                    <div class="form-group clearfix">
                        {!! Form::submit('Save', ['class' => 'btn btn-primary btn-md btn-block', 'ng-click'=>'formSubmit()']) !!}
                    </div>
                </div><!-- /.box-footer-->
