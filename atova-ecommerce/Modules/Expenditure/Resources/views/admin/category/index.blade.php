...
<section class="content">
    ...
    <a href="{{ url('expenditure/admin/categories/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>{{ $category->note }}</td>
                        <td class="text-right">
                            <a title="Edit" href="{{ url('expenditure/admin/categories/' . $category->id .'/edit') }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                        </td>
                    </tr>
                @endforeach
