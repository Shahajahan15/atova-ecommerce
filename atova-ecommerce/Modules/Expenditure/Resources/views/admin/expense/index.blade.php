...
<section class="content">
    ...
    <a href="{{ url('expenditure/admin/expenses/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($expenses as $expense)
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $expense->id }} </td>
                        <td>{{ $expense->recipient->first_name . ' ' .$expense->recipient->last_name }}</td>
                        <td>{{ $expense->amount }}</td>
                        <td>
                            <a title="Edit" href="{{ url('expenditure/admin/expenses/' . $expense->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View </a>
                        </td>
                    </tr>
                @endforeach
