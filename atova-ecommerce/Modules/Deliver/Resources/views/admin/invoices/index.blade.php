...
<section class="content">
    ...
    <a href="{{ url('deliver/admin/invoices/create') }}" class="btn btn-primary">
            ...
            <table id="datatable" class="table table-bordered table-striped">
                ...
                @foreach($invoices as $invoice)
                    <tr>
                        ...
                        <td> {{ $invoice->date }} </td>
                        <td class="text-right">
                            <a title="View" href="{{ url('deliver/admin/invoices/' . $invoice->id .'/edit') }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View </a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
