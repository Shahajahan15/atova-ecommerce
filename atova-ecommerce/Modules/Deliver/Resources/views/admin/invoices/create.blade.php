...
<section class="content">
    ...
    <a href="{{ url('deliver/admin/invoices') }}" class="btn btn-primary">
    ...
    <!-- Default box -->
    @if($mode == 'edit')
        {!! Form::model($invoice, ['method'=>'PUT', 'url' => 'deliver/admin/invoices/' . $invoice->id, 'role'=>'form', 'files'=>true]) !!}
    @else
        {!! Form::open(['method'=>'POST', 'url' => 'deliver/admin/invoices', 'role'=>'form', 'files'=>true]) !!}
    @endif
...
@section('foot_js')
    {!! Html::script('assets/modules/deliver/new_invoice.js') !!}
