        ...
        <div class="col-md-4">
            ...
            <div class="box box-default">
                        ...
                        <table class="table table-bordered" border="1">
                            <tbody>
                                ...
                                @if($invoice->status != 1)
                                    <tr>
                                        <td>
                                            {!! Form::select('title', $paymentMethods, 1, ['class'=> 'form-control input-invoice', 'ng-model'=>'paymentMethod']) !!}
                                        </td>
                                        <td>
                ...
                <div class="box-footer">
                        ...
                        {!! Form::open(['method'=>'PUT', 'url' => 'deliver/admin/invoices/' . $invoice->id, 'role'=>'form', 'files'=>true]) !!}
                        <table class="table">
                            <tr>
                                <th class="text-right">
                                    Status :
                                ...
                                <td>
                                    {!! Form::select('status', $status, $invoice->deliver__status_id, ['class'=> 'form-control input-invoice']) !!}
                                </td>
                                <td>
...
@section('foot_js')
    ...
    {!! Html::script('assets/modules/deliver/deliver_invoice.js') !!}
